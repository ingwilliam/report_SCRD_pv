...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/PropuestasWS/reporte_listado_propuesta_rechazados_habilitados/");
...
$pdf->Output('listado_propuesta_habilitadas_rechazadas_'.$_GET["id"].'.pdf', 'D');
