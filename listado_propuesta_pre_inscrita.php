...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('LISTADO DE PRE INSCRIPCIÓN');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/PropuestasWS/reporte_listado_pre_inscrita/");
...
$pdf->Output('listado_propuesta_pre_inscrita_'.$_GET["id"].'.pdf', 'D');
