...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('REPORTE GANADORES');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ConvocatoriasFormatos/reporte_ganadores/");
// indicamos el tipo de petición: POST
curl_setopt($ch, CURLOPT_POST, TRUE);
// definimos cada uno de los parámetros
curl_setopt($ch, CURLOPT_POSTFIELDS, "token=".$_GET["token"]."&nd=".$_GET["nd"]."&anio=".$_GET["anio"]."&entidad=".$_GET["entidad"]."&convocatoria=".$_GET["convocatoria"]);
...
$pdf->Output('reporte_ganadores_'.$_GET["nd"].'.pdf', 'D');
