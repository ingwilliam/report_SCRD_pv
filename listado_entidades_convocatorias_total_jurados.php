...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ConvocatoriasFormatos/reporte_listado_entidades_convocatorias_total_jurados/");
...
$pdf->Output('listado_entidades_convocatorias_total_jurados_'.$_GET["entidad"].'_'.$_GET["anio"].'.pdf', 'D');
