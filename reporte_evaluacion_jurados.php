...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('REPORTE JURADOS POSTULADOS');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ReportejuradosevaluacionPDF/evaluacionjuradospostulados/convocatoria/".$_GET["convocatoria"]);
...
$pdf->Output('evaluacion_jurados_postulados_'.$_GET["convocatoria"].'.pdf', 'D');
