...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('CERTIFICADO DE SUBSANACIÓN');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/PropuestasWS/reporte_propuesta_subsanacion/");
...
$pdf->Output('propuesta_subsanacion_'.$_GET["id"].'.pdf', 'I');
