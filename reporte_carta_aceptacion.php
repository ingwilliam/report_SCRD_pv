...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('REPORTE CARTA JURADOS POSTULADOS');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ReportecartaPDF/carta_aceptacion_notificacion/postulacion/".$_GET["postulacion"]);
...
$pdf->Output('jurados_postulados_'.$_GET["convocatoria"].'.pdf', 'D');
