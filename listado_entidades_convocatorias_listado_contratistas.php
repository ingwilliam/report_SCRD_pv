...
class MYPDF extends TCPDF {
        ...
        public function Header() {
                // Logo
                $image_file = 'images/scrd_logo_2.png';
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ConvocatoriasFormatos/reporte_listado_entidades_convocatorias_listado_contratistas/");
...
$pdf->Output('listado_entidades_convocatorias_listado_contratistas_'.$_GET["entidad"].'_'.$_GET["anio"].'_'.$_GET["convocatoria"].'.pdf', 'D');
