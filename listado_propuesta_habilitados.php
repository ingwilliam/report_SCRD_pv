...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('LISTADO DE HABILITADOS');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/PropuestasWS/reporte_listado_propuesta_habilitados/");
...
$pdf->Output('listado_propuesta_habilitadas_'.$_GET["id"].'.pdf', 'D');
