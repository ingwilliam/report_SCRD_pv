...
$pdf->SetAuthor('SCRD');
$pdf->SetTitle('LINEA BASE DE JURADOS');
...
curl_setopt($ch, CURLOPT_URL,$url_api."/crud_SCRD_pv/api/ConvocatoriasFormatos/reporte_linea_base_jurados_xls/");
...
$pdf->Output('linea_base_de_jurados'.$_GET["entidad"].'_'.$_GET["anio"].'.pdf', 'D');
